...
//Current time on military hour
var hour = moment().format("H");
var CurrentTime = parseInt(hour);
//Grabbing data-hour from html and converting to Integer
...
// comparisions between current time and and time blocks to set past present of future color
...
// getting loca storage for each time
function init() {
